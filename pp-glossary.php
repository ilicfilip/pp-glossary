...
/**
 * Register frontend assets for conditional enqueuing.
 *
 * Assets are enqueued later by the content filter (when glossary terms
 * are found) or by the glossary list block render callback.
 */
